...
import ru.aston.module4.exception.ValidationErrorResponse;
...
public class UserController {
	...
	@Operation(summary = "Добавить нового пользователя",
			responses = {
					@ApiResponse(
							responseCode = "201",
							description = "Успешная операция добавления",
					...
					@ApiResponse(
							responseCode = "409",
							description = "Использование уже существующей почты",
							content = @Content(schema = @Schema(implementation = AlreadyExistException.class)))
			})
	...
	@Operation(summary = "Удалить пользователя по id",
			responses = {
					@ApiResponse(
							responseCode = "204",
							description = "Успешная операция удаления"),
					@ApiResponse(
							responseCode = "400",
							description = "Ошибка при вводе данных",
							content = @Content(schema = @Schema(implementation = ValidationErrorResponse.class))),
